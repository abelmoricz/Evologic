      ...
      return (
        <div className="landing">
          ...
          <div className=" container-fluid">
            <div className="row">
              <div className="col-sm-3"><NavLink to="/mission"><Image text={<img src={w_goal2} />} img={goal2} /></NavLink></div>
              <div className="col-sm-3"><NavLink to="/mission"><Image text={<img src={w_goal6} />} img={goal6} /></NavLink></div>
              <div className="col-sm-3"><NavLink to="/mission"><Image text={<img src={w_goal12} />} img={goal12} /></NavLink></div>
              <div className="col-sm-3"><NavLink to="/mission"><Image text={<img src={w_goal15} />} img={goal15} /></NavLink></div>
            </div>
          </div>
          ...
          <div className="my-10">
            ...
            <div className="row" align="middle">
              <NavLink to="/mission" className="col-xl">
              ...
              <NavLink to="/mission"  class="col-xl">
