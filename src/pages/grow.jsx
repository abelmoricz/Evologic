      ...
      return (
        <div className="grow">
          ...
          <div className="bg_image_1">
            ...
            <div className="plants col-lg-5 offset-lg-5">
            ...
            <div className="fungi col-lg-5 offset-lg-1">
              ...
              <NavLink to="/grow/fungi"><h3 className="green">Phoma</h3></NavLink>
              <NavLink to="/grow/fungi"><h3 className="green my-4">MycoProScale</h3></NavLink>
            </div>

            <div className="bacteria col-lg-6 offset-lg-5">
